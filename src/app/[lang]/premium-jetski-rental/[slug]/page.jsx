...
async function getData(slug) {
  let api = `${process.env.NEXT_PUBLIC_BACKEND_URL}/jetskis?filters[slug][$eq]=${slug.slug}&populate=*`;
...
const page = async ({ params }) => {
  ...
  const mapData = [
    {
      title: "30 minutes",
      img: "/assets/jetski/30 minutes route.jpeg",
    },
    {
      title: "60 minutes",
      img: "/assets/jetski/60 minutes.jpg",
    },
    {
      title: "90 minutes",
      img: "/assets/jetski/90 minutes route.jpeg",
    },
    {
      title: "120 minutes",
      img: "/assets/jetski/120 minutes  route.jpeg",
    },
  ];
            ...
            <div className="w-full h-full ">
              <div className="grid grid-cols-1 md:grid-cols-2 max-w-[1200px] mx-auto gap-8">
                ...
                {mapData.map((e, index) => (
                  <div
                    key={index}
                    className="border w-full  rounded-lg shadow-lg"
                  >
